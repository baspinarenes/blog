...
export default async function Image({ params }: PageProps) {
  const entity = await ContentfulGraphqlClient.getEntryBySlug(ContentfulEntity.THOUGHT, params.slug, params.lng);
  const logo = await ContentfulGraphqlClient.getAssetUrl(`logo-${ContentfulEntity.THOUGHT}`);
