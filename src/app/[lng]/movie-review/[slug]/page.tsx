    ...
    <>
      <div className="relative overflow-hidden rounded-2xl mb-8">
        ...
        <div className="text-yellow-300 text-[10px] lg:text-sm">
          <div className="absolute left-0 top-0 px-2 lg:px-4 py-1 bg-black rounded-br-2xl">
            {formatDate(movieReview.releasedAt, lng)}
          </div>
          <div className="absolute right-0 top-0 px-2 lg:px-4 py-1 bg-black rounded-bl-2xl">{movieReview.category}</div>
          <div className="absolute right-0 bottom-0 px-2 lg:px-4 py-1 bg-black rounded-tl-2xl">
            {movieReview.director}
          </div>
          <div className="absolute left-0 bottom-0 flex flex-col items-end bg-black px-2 lg:px-4 py-2 rounded-tr-2xl">
