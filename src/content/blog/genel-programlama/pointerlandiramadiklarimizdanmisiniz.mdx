...
import CodeResult from "../../../components/CodeResult.astro";
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/001.webp"
  width={718}
  height={167}
  fluid
/> */}
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/002.png"
  width={856}
  height={504}
  fluid
/> */}
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/003.png"
  width={869}
  height={492}
  fluid
/> */}
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/004.png"
  width={728}
  height={243}
/> */}
...
<CodeResult>1999 0x7ffd83c692bc 0x7ffd83c692bc</CodeResult>
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/005.png"
  width={1000}
  height={400}
  fluid
/> */}
...
<CodeResult>0x7ffc0206d83c // başındaki "0x" hexadecimal olduğunu belirtir</CodeResult>
...
<MessageBox type="info">
  Bu kısma geçmeden önce küçük bir ipucu vermek istiyorum. String değişkenler tanımlarken `char[] isim = "Ahmet"`
...
<CodeResult>0x7ffcd4fb610c 0x7ffcd4fb610c 0x7ffcd4fb610c</CodeResult>
...
{/* <CustomImage
  src="/src/assets/articles/genel-programlama/pointerlandiramadiklarimizdanmisiniz/006.png"
  width={1200}
  height={400}
  fluid
/> */}
...
<MessageBox type="info">
  ...
  `sayi_dizisi_ptr += 1;` ifadesi adresi kalıcı olarak değiştirir. Sonraki adresi yazdırmak amacıyla `sayi_dizisi_ptr +
  1;` ifadesini kullansaydık adresin değeri değişmezdi. Oradaki = kritik öneme sahiptir.
</MessageBox>
