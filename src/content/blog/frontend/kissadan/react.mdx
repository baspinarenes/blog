...
description: "React hakkında tuttuğum kısa notlar."
pubDate: 2022-12-12
slug: kissadan-react
draft: false
heroImage: "/src/assets/articles/frontend/kissadan/react/hero-image.png"
tags:
  - framework
otherParts:
  - text: "React"
    slug: "/blog/kissadan-react"
  - text: "Golang"
    slug: "/blog/kissadan-golang"
---

<MessageBox type="warning">
  **Yaşayan Yazı**, bir yerimden uydurduğum bir terimdir ve ileriki dönemde içeriği zenginleşecek ama şu anki haliyle de
  faydalı olabilecek yazıları belirtir.
</MessageBox>
...
<MessageBox type="info">
  `key` olarak uuid üreten bir kütüphane yada apiden dönen id değerini kullanabilirsiniz. Aksi halde şu hatayı
  alırsınız: 'Warning: Each child in a list should have a unique “key” prop.'
</MessageBox>

<MessageBox type="info">
  `key` özelliğine her seferinde rastgele değer üreten bir metod verilirse (örneğin Math.random) DOM'a her seferinde
...
```javascript title="tasksReducer.js"
...
```javascript title="Section.jsx"
import { LevelContextProvider } from "./LevelContext.js";

export default function Section({ level, children }) {
  return (
    <section className="section">
      <LevelContextProvider value={level}>{children}</LevelContextProvider>
    </section>
  );
}
```

```javascript title="Heading.jsx"
...
```javascript title="LevelContext.jsx"
