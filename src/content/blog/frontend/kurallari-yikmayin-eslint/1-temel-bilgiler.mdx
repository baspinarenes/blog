...
Az sonra kitabi olmasa da bir tanımla karşılaşacaksınız. Tanımları hiç sevmem o yüzden çok üzerinde durmayacağım. Çok üzerinde durmadan arkalara doğru ilerleyelim. Bizim işimiz tanım ezberlemek değil, işin özüne dair fikir edinmek.
</MessageBox>
...
*extends* kısmı, kural setlerini oluşturan ekibin tavsiye
...
sayede sadece özelleştirmek istediğimiz kuralları *rules* altında
