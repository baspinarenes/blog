---
title: "Web API'nin İncelikleri: Console"
description: "Console nesnesinin log metodunu metodunu çokca kullanıyoruz. Peki yaptıkları bununla sınırlı mı?"
pubDate: 2022-09-23
slug: web-apinin-incelikleri-console
draft: false
...
<MessageBox type="info">
  Tarayıcıda çalışsa da Node terminalinde temizlemez. Eğer bu işlevi isteniyorsa `process.stdout.write('\033c');` gibi
  stdout'a direk müdahale eden bir kod tercih edilebilir.
</MessageBox>
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/001.png)
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/002.png)
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/003.png)
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/004.png)
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/005.png)
...
![](/src/assets/articles/frontend/tarayicinin-alametleri-console-api/006.png)
