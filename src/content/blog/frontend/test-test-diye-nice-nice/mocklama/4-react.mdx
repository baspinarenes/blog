...
description: "React komponentleri kullanırken mocklamanın nasıl çalıştığını görelim."
pubDate: 2022-12-01
slug: test-test-diye-nice-nice-mocklama-4-react
draft: false
heroImage: "/src/assets/articles/frontend/test-test-diye-nice-nice/mocklama/1-fonksiyon/001.jpeg"
tags:
  - jest
  - testing-library
  - mocking
otherParts:
  - text: "Part 1 - Fonksiyon"
    slug: "/blog/test-test-diye-nice-nice-mocklama-1-fonksiyon"
  - text: "Part 2 - Modül"
    slug: "/blog/test-test-diye-nice-nice-mocklama-2-modul"
  - text: "Part 3 - Timer"
    slug: "/blog/test-test-diye-nice-nice-mocklama-3-timer"
  - text: "Part 4 - React"
    slug: "/blog/test-test-diye-nice-nice-mocklama-4-react"
---

<MessageBox type="info">
  Angular sevdiğimiz bir abimizdi. Karmaşık bir framework'tü, her şeyi yapmaya çalışırdı. Mesela ben yapmam. Bundle
  size'ı arttırırdı, ben arttırmam. Developerlar'ın işi düştüğünde sırtını dönerdi, ben dönmem. Angular sevdiğimiz bir
  abimizdi ama komponentleri de bir tuhaf render'lardı. Bizde hook'lar masaya konur. Herkes ihtiyacı kadarını alır.
  Eskiler sende kalsın kardeş, junior'ların kafasını karıştırma yeter.
  <br />
  **- React**
</MessageBox>
...
<MessageBox type="info">
  Yazının kodlarına [Github](https://github.com/baspinarenes/blog-code-examples/tree/main/jest-mocking-4-react)
...
const RegisterForm = () => {
  ...
  return <form onSubmit={handleRegisterSubmit}>...</form>;
};
...
<MessageBox type="info">
  Örnekleri basit tutmaya çalışacağım ve her seferinde farklı biçimde yazışlar göstereceğim ki kullanım örneklerini
  kafamızda çeşitlendirelim. Temel fikre odaklanırsanız kendi örneklerinize uygulayabileceğinizi düşünüyorum.
</MessageBox>
...
describe("<Registration> tests", () => {
  test("should render <RegisterForm /> when isRegistered equal false", () => {
    jest.spyOn(RegisterFormModule, "default").mockReturnValue(<div data-testid="register-form" />);
  ...
  test("should render <LoginForm /> when isRegistered equal true", () => {
    jest.spyOn(LoginFormModule, "default").mockReturnValue(<div data-testid="login-form" />);
...
jest.mock("./TodoItem", () => jest.fn().mockReturnValue(<div data-testid="todo-item" />));
...
<MessageBox type="info">
  Örneğimizi rastgele seçtiğim `react-lazyload` kütüphanesi üzerinden gösteriyor olacağım. Bunun yerine diğer herhangi
  bir kütüphane gelebilir.
</MessageBox>
...
<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/2ZHK-hVhELc"
