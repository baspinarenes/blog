...
- [Test Test Diye Nice Nice: Mocklama (1) - Fonksiyon](/blog/test-test-diye-nice-nice-mocklama-1-fonksiyon)
...
<MessageBox type="info">
**Fonksiyonları kullanmadan önce mocklamıştık. Modüllerin de import edilmeden önce mocklanması gerekmez mi?**<br /><br />Çok güzel bir noktaya parmak bastın. Herhangi bir nesnenin kullanılmadan önce mocklanması zorunludur. Fakat biliyoruz ki `import` ifadelerinin dosyanın en üstünde olması JS yazılımcılarının genel alışkanlığıdır. Jest'de bu yapıyı bozmamak adına `jest. mock` ifadelerini hoist eder yani import'un üzerine taşır.
</MessageBox>
...
<MessageBox type="info">
**Peki ne zaman `factory` kullanmalıyız?** <br /><br /> Fonksiyonların mocklamaları testler boyunca aynı kalacaksa, default  mock değeri tanımlamamız gerekiyorsa ya da kısmi mocklama yapacaksak  kullanabiliriz.
</MessageBox>
